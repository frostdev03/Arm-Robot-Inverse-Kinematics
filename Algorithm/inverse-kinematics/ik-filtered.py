...
url = 'http://192.168.16.201:81/stream'  # Ganti dengan URL streaming yang benar
...
#                 objective_function, 
#                 initial_guess, 
#                 method='SLSQP',  # SLSQP, CG, Powell, COBYLA, BFGS
#                 bounds=bounds,
...
def main():
    # Alamat IP ESP32
    ESP32_IP = "192.168.16.37"  # Ganti dengan IP ESP32 Anda
    ESP32_PORT = 81
    ...
    # Variabel untuk mengontrol delay deteksi
    last_detection_time = 0
    detection_delay = 1.0  # Delay 1 detik antara deteksi
    ...
    try:
        ...
        while True:
            ...
            # Hanya proses deteksi jika sudah lewat 1 detik sejak deteksi terakhir
